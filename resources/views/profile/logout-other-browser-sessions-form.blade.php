<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Mantén segura tu cuenta cerrando las sesiones activas en otros navegadores y dispositivos.') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Si es necesario, puedes cerrar sesiones activas en tus otros navegadores en cualquiera de tus dispositivos. Algunas de tus sesiones recientes se encuentran listadas aquí abajo; sin embargo, esta lista puede no contener todas las sesiones. Si sientes que tu cuenta está en peligro, deberías actualizar tu contraseña adicionalmente.') }}
        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Por favor ingresa tu contraseña para confirmar que quieres cerrar las sesiones activas en otros navegadores.') }}
