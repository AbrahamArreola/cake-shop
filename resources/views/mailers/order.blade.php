                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                              <h1 class="h1">Recibo de tu orden de Cupcake Mio</h1>
                                                              <br />
                                                              <br />
                                                              <strong>¡Hola! {{$order->user->name}}</strong>
                                                              <br />
                                                              <p>Te enviamos los datos de tu compra realizada en Cupcake Mio el día <strong>{{$order->created_at}}</strong>
                                                              por un total de $<strong>{{$order->amount}} MXN</strong></p>
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                          ...
                                                          <table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
                                                              ...
                                                              @foreach($products as $product)
                                                                <tr mc:repeatable>
                                                                  ...
                                                                  <td valign="top" width="10" class="data_table_content00">
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; 2020 Cupcake Mio, All rights reserved.</em>
																<br />
